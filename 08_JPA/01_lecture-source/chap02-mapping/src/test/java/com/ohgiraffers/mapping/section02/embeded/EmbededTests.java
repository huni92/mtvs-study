...
public class EmbededTests {
    ...
    private static Stream<Arguments> negativeDiscountPrice() {
        return Stream.of(
                Arguments.of(
                        "자바의정석",
                        "남궁성",
    ...
    @ParameterizedTest
    @MethodSource("negativeDiscountPrice")
    void testNegativeDiscountPrice(String bookTitle, String author, String publisher, LocalDate publishedDate,
                                   int regularPrice, double discountRate) {
